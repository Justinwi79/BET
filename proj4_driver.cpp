...
{  
   ...
   cout <<"Number of Leaf Nodes  in myinfix2: "<<myinfix2.leaf_nodes() 
<<endl;
   ...
   cout <<"Number of Leaf Nodes in myinfx1: " 
<<myinfix1.leaf_nodes()<<endl; 
   cout <<"Size of myinfix1: "<<myinfix1.size()<<endl;
   cout <<" Testing the assignment operator= overload" <<endl; 
   myinfix3=myinfix2; 
   cout<<"Size of myinfix3 (copied from myinfx2) is: " 
<<myinfix3.size()<<endl; 
